...
from CustomLanguageModel1 import CustomLanguageModel1
...
def main():
  ...
  print 'Unsmoothed Trigrams with stupid backoff: '
  customLM = CustomLanguageModel(trainingCorpus)
  customSpell = SpellCorrect(customLM, trainingCorpus)
  customOutcome = customSpell.evaluate(devCorpus)
  print str(customOutcome)

  print 'Linear Interpolation of 1,2,3-Grams'
  linearIntLM = CustomLanguageModel1(trainingCorpus)
  linearIntSpell = SpellCorrect(linearIntLM,trainingCorpus)
  linearIntOutcome = linearIntSpell.evaluate(devCorpus)
  print str(linearIntOutcome)
